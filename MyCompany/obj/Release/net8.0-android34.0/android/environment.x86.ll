...
@dso_cache = dso_local local_unnamed_addr global [522 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1346962339, ; hash 0x504903a3, from name: aot-MyCompany.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1508607768, ; hash 0x59eb8718, from name: libaot-MyCompany.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 177
	...
	%struct.DSOCacheEntry {
		i64 1929017006, ; hash 0x72fa76ae, from name: MyCompany.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 219
	...
	%struct.DSOCacheEntry {
		i64 2489677290, ; hash 0x946575ea, from name: MyCompany
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 296
	...
	%struct.DSOCacheEntry {
		i64 2859150368, ; hash 0xaa6b2c20, from name: libaot-MyCompany
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 348
	...
	%struct.DSOCacheEntry {
		i64 2964855855, ; hash 0xb0b81c2f, from name: aot-MyCompany
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 362
