...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670756, ; uint32_t jnienv_initialize_method_token (0x6001d24)
	i32 100670755, ; uint32_t jnienv_registerjninatives_method_token (0x6001d23)
...
@dso_cache = dso_local local_unnamed_addr global [522 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4994540860914914591, ; hash 0x45502c736701d51f, from name: libaot-MyCompany.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 130
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5336543225954374474, ; hash 0x4a0f35ca2f87134a, from name: libaot-MyCompany
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 139
	...
	%struct.DSOCacheEntry {
		i64 6247278856949077273, ; hash 0x56b2cb0559421519, from name: aot-MyCompany.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 152
	...
	%struct.DSOCacheEntry {
		i64 11337153495743520911, ; hash 0x9d55a9099ddee08f, from name: aot-MyCompany
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 311
	...
	%struct.DSOCacheEntry {
		i64 14998464113427245740, ; hash 0xd0253fa559466aac, from name: MyCompany
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 426
	...
	%struct.DSOCacheEntry {
		i64 16423070234435367575, ; hash 0xe3ea775d74cfb297, from name: MyCompany.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MyCompany.dll.so
		ptr null; void* handle (0x0)
	}, ; 467
...
@.env.3 = private unnamed_addr constant [37 x i8] c"9d166791-3a22-4499-a9f4-ea69881bfaf4\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [18 x i8] c"com.aht.mycompany\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [24 x i8] c"libaot-MyCompany.dll.so\00", align 1
...
@.DSOCacheEntry.82_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 1
